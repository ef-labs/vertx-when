...
promises.add(whenContainer.deployModule("com.englishtown~vertx-mod-hk2~1.0.0-final"));
promises.add(whenContainer.deployModule("com.englishtown~vertx-mod-jersey~1.0.0-final"));
